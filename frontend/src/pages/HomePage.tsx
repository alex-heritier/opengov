    ...
    <div className="w-full max-w-6xl mx-auto">
      <section className="text-center space-y-4 sm:space-y-6 py-8 sm:py-12 px-4">
        ...
        <p className="text-base sm:text-lg md:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
          Get daily updates about Federal Register announcements, policy
          changes, and government actions. Stay up-to-date with what matters to
          you.
        </p>
        <div className="pt-4 sm:pt-6">
          <Button
            asChild
            size="lg"
            className="text-sm sm:text-base h-11 sm:h-12 px-6 sm:px-8"
          >
            <Link to="/feed">View Latest Updates</Link>
          </Button>
        </div>
      </section>
      ...
      <section className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 py-8 sm:py-12 px-4">
        ...
        <div className="space-y-3 text-center sm:text-left">
          ...
          <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
            Complex government documents summarized by AI for easy
            understanding.
          </p>
        </div>
