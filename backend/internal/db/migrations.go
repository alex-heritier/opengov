...
func (db *DB) addMissingColumns(tx *sql.Tx) error {
	...
	err := tx.QueryRow("SELECT COUNT(*) FROM information_schema.columns WHERE table_name = 'frarticles' AND column_name = 'source'").Scan(&count)
	if err != nil {
		return err
	}
	if count == 0 {
	...
	err = tx.QueryRow("SELECT COUNT(*) FROM information_schema.columns WHERE table_name = 'frarticles' AND column_name = 'document_type'").Scan(&count)
	if err != nil {
		return err
	}
	if count == 0 {
	...
	err = tx.QueryRow("SELECT COUNT(*) FROM information_schema.columns WHERE table_name = 'frarticles' AND column_name = 'pdf_url'").Scan(&count)
	if err != nil {
		return err
	}
	if count == 0 {
	...
	err = tx.QueryRow("SELECT COUNT(*) FROM information_schema.columns WHERE table_name = 'users' AND column_name = 'state'").Scan(&count)
	if err != nil {
		return err
	}
	if count == 0 {
	...
	err = tx.QueryRow("SELECT COUNT(*) FROM information_schema.columns WHERE table_name = 'agencies' AND column_name = 'raw_name'").Scan(&count)
	if err != nil {
		return err
	}
	if count == 0 {
